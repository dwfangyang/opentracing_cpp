...
#include "yyop.h"
#include <opentracing/yytracer.h>

namespace opentracing {
    BEGIN_OPENTRACING_ABI_NAMESPACE
    namespace {
        class YSpanContext : public SpanContext {
        public:
        ...
        class YSpan : public Span {
        public:
            explicit YSpan(std::shared_ptr<const Tracer>&& tracer) noexcept
        ...
        class YTracer : public Tracer,public std::enable_shared_from_this<YTracer>{
        public:
